...
export const SYSTEM_FIELDS = {
  ...
  workstation: [
    ...
    { field: 'ws_product_count', label: '工位产品数量', example: '2' },
  ...
  product: [
    { field: 'product_name', label: '产品名称', example: '产品 A' },
    { field: 'product_code', label: '产品编号', example: 'P-001' },
    { field: 'product_spec', label: '产品规格', example: '标准型' },
    { field: 'product_index', label: '产品序号', example: '1' },
    { field: 'product_length', label: '产品长度 (mm)', example: '300' },
    { field: 'product_width', label: '产品宽度 (mm)', example: '200' },
    { field: 'product_height', label: '产品高度 (mm)', example: '50' },
    { field: 'product_dimensions', label: '产品尺寸', example: '300×200×50 mm' },
    { field: 'product_snapshot', label: '产品标注图', example: 'https://...' },
    { field: 'product_preview', label: '产品预览图', example: 'https://...' },
  ],
  module: [
